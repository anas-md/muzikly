    ...
    <div className="flex h-full flex-col gap-5 overflow-hidden p-5">
      <div className="flex h-36 shrink-0 gap-5">
        {bars.map((e, i) => (
          <div
            key={i}
            className="flex h-full w-full flex-col justify-between rounded-md border border-slate-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-600/10"
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-black/80 dark:text-white/70">
                {e?.small_data}
              </span>
            </div>
          </div>
