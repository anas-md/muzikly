...
<div style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center">
    <div style="max-width: 28rem; padding: 1.25rem; border-radius: 0.375rem; background-color: #f9fafb; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05)">
        ...
        <a href="${getEnvVariable('HOST_URI')}/forgot-password/${token}" style="border-radius: 0.25rem; background-color: #6366f1; color: #ffffff; padding: 0.5rem 1rem; text-decoration: none; display: inline-block; margin: 0 auto">Reset Your Password</a>
        </div>
